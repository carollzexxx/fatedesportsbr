...
export default function FatedWebsite() {
    return (
        <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center justify-center px-6 text-center">
                <div className="max-w-4xl animate-in fade-in zoom-in duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black uppercase leading-tight">
                        Welcome to{" "}
                        <span className="text-purple-500">Fated</span>
                    </h1>

                    <p className="mt-6 text-gray-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                        Uma organização focada em competitividade, comunidade e
                        evolução nos jogos online. Atualmente no Valorant,
                        futuramente expandindo para League of Legends e outros
                        cenários.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-gray-300 leading-relaxed mb-4">
                            A Fated nasceu com o objetivo de criar uma
                            comunidade competitiva forte, organizada e unida
                            dentro dos jogos online.
                        </p>

                        <p className="text-gray-400 leading-relaxed">
                            Nosso foco atual está no Valorant, buscando evolução
                            constante, campeonatos, criação de conteúdo e
            ...
            <section
                id="jogos"
                className="py-28 bg-zinc-950 border-y border-purple-500/10"
            >
                <div className="max-w-6xl mx-auto px-6">
                    <h2 className="text-4xl font-bold text-center mb-16">
                        Jogos da{" "}
                        <span className="text-purple-500">Organização</span>
                    </h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-black border border-purple-500/20 rounded-3xl p-8 hover:-translate-y-2 transition duration-300 shadow-xl shadow-purple-900/10">
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                Competitividade, estratégia e evolução constante
                                no cenário tático.
                            </p>
                        </div>
            ...
            <section
                id="recrutamento"
                className="py-28 bg-zinc-950 border-t border-purple-500/10"
            >
                <div className="max-w-3xl mx-auto px-6 text-center">
                    ...
                    <p className="text-gray-400 mb-10">
                        Procuramos jogadores comprometidos, competitivos e
                        focados em evolução.
                    </p>
